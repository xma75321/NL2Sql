...
import pandas as pd
# pylint: disable  MC80OmFIVnBZMlhwcWF6bW5wZmx1Ymc2TVV3d1Z3PT06YjAxNmZjMDg=
...
# type: ignore  MS80OmFIVnBZMlhwcWF6bW5wZmx1Ymc2TVV3d1Z3PT06YjAxNmZjMDg=
    ...
    async def run_sql(self, args: RunSqlToolArgs, context: ToolContext) -> pd.DataFrame:
        ...
        try:
            ...
            if sql.endswith(";"):
                sql = sql[:-1]
# type: ignore  Mi80OmFIVnBZMlhwcWF6bW5wZmx1Ymc2TVV3d1Z3PT06YjAxNmZjMDg=
            ...
            cursor.close()
            return df
# fmt: off  My80OmFIVnBZMlhwcWF6bW5wZmx1Ymc2TVV3d1Z3PT06YjAxNmZjMDg=
