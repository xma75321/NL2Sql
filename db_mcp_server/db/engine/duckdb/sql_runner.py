...
import pandas as pd
# fmt: off  MC8zOmFIVnBZMlhwcWF6bW5wZmx1Ymc2ZUhaQk9BPT06YWQyODRiZGQ=
...
class DuckDBRunner(SqlRunner):
    ...
    def __init__(
        ...
        try:
            import duckdb
# fmt: off  MS8zOmFIVnBZMlhwcWF6bW5wZmx1Ymc2ZUhaQk9BPT06YWQyODRiZGQ=
    ...
    async def run_sql(self, args: RunSqlToolArgs, context: ToolContext) -> pd.DataFrame:
        ...
        return df
# pragma: no cover  Mi8zOmFIVnBZMlhwcWF6bW5wZmx1Ymc2ZUhaQk9BPT06YWQyODRiZGQ=
